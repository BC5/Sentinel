...
public class Config
{
    ...
    public async Task<string> QuoteProcess(string quote, SocketGuildUser sender, ServerUser susender, Detention detention, ServerConfig sconf, SentinelDatabase data)
    {
