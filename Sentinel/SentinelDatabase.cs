...
public class SentinelDatabase : DbContext
{
    ...
    public SentinelDatabase()
    {
        
    }
    
    public SentinelDatabase(string file)
    {
        DbPath = file;
    }
...
*/
    ...
    public async Task<ServerConfig?> GetServerConfigNoCreate(ulong server)
    {
