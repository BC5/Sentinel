...
public class NewMessageHandler
{
    ...
    private SentinelBot.Regexes _regexes;
    private Detention _detention;
    private Config _config;
    private Random _random;
    private TextCat _textcat;

    public NewMessageHandler(DiscordSocketClient discord, SentinelBot bot, OCRManager ocr, SentinelBot.Regexes regex,
    ...
    private async Task<bool> NewIdiot(SocketGuildUser? sgu, IMessage msg, ServerConfig srv, SocketGuildChannel channel, SentinelDatabase data)
    {
    ...
    private async Task RandomQuote(SocketMessage msg, SocketGuildUser sgu, ServerUser user, ServerConfig srv, SentinelDatabase data)
    {
