...
public class Detention
{
    ...
    public Detention(SentinelBot _bot, DiscordSocketClient discord)
    {
        this._bot = _bot;
        _discord = discord;
    }
    ...
    public async Task ModifySentence(IMessage msg, SocketGuildChannel channel, TimeSpan duration, SentinelDatabase data)
    {
    ...
    public async Task ModifySentence(IGuildUser gu, TimeSpan duration, SentinelDatabase data)
    {
